...
/*
We shall use this refactored FetchWeatherTask later in the class . The we shall uncomment the same.
presently FetchWeatherTask is an inner class in  ForecastFragment.java
 */
