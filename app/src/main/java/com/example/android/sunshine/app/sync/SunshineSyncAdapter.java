...
/*
Below projection added to configure notifications
 */
...
//            }
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor c = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI, new String[]{WeatherContract.LocationEntry._ID},
...
// check for notification setting and then enable
